...
* When `month(date)` is `T`emporal we had a bar graph which marks dates for the beginning of each month. The labels are at the tick marks. We have 13 labels because we also pick up an extra "Jan" at the end
