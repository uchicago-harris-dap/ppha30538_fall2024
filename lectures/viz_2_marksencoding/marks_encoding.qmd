...
=======
>>>>>>> b31a24ff9f98269de88e95d5e08d1ef28309b049
...
FYI this "Y" plot is pretty confusing as a standalone plot. It is needed because it is a setup for subsequent plots. You can say that

In-class exercise: what happens if you swap the Q and the O types? (skipped this for time reasons)
...
::: {.notes .content-visible when-profile="speaker"}
**NOTES:**
This plot is not effective! Don't make a plot like this. Hard to see where "Canada" is because it is blue in the legend but is orange on the plot.
:::
