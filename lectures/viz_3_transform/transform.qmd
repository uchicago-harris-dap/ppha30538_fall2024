...
Answer: summer and holiday season
...
**NOTES:**
*solution:
The former is "better" since it is easier to read.

But if you as a programmer ever want to troubleshoot what's going on, it is useful for you to know what's happening under the hood. And the second code block reveals that clearly*
:::
