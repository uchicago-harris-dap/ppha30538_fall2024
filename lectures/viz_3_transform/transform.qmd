...
Notes: 
- You have to write print() in the code chunks for your code to be printed 
- Write your analysis in the text outside of the code chunks 
- Be sure to write out the answer to every element of the question 
...
Bin = True is just creating an automatic bin structure that is not prescribed. It has created 10 bins (groups). 
...
- This is great because you know what you want to do and the computer can speed you up. Use this as a reference for how you should be using ChatGPT in your problem set. 
...
The difference here between the two graphs: 
- this graph shows where the majority of the distribution of the reviews are located (25% to 75% percentiles) 
- for the documentary movie there is more agreement among critics that the very bad one is still very good! but can't say the same for horror
...
Some of the issues: 
- Can see the inflation so that yes will always increase 
- Can also see where the dataset ends 
...
You could also use the median or the max or average for the value when it comes to US Gross. The median is not sensitive to outliers. 
