...
### Pulling this week's material -- `main` branch

![Sync fork](pictures/sync_main.png)

### Pulling this week's material -- `after_lecture` branch

![Switch branches](pictures/switch_branches.png)

Then hit "sync fork again"
